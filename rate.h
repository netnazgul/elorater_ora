...
#ifndef __RATE_FUNCTION_HEADER_FILE_WITH_TPLAYER_DEFINED__
#define __RATE_FUNCTION_HEADER_FILE_WITH_TPLAYER_DEFINED__
...
void ComputeHarknessRatings(CPlayer& white, CPlayer& black, 
                            float whiteScore, float blackScore);

#endif //__RATE_FUNCTION_HEADER_FILE_WITH_TPLAYER_DEFINED__
